...
export default function MessagesPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 md:p-6 h-full">
      <h1 className="hidden md:block text-2xl md:text-3xl font-bold tracking-tight text-white mb-2">Messages</h1>
      <p className="hidden md:block text-muted-foreground mb-6 md:mb-8 text-sm md:text-base">Start a conversation with your matches</p>
