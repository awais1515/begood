      ...
      const fetchProfile = async () => {
        ...
        try {
          ...
          if (userDocSnap.exists()) {
            ...
            const age = firestoreData.birthYear ? (() => {
              const today = new Date();
              const birthMonth = firestoreData.birthMonth || 1;
              const birthDay = firestoreData.birthDay || 1;
              let calculatedAge = today.getFullYear() - parseInt(firestoreData.birthYear, 10);
